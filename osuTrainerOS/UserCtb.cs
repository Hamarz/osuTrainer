    ...
    public class UserCtb : IUser
    {
        ...
        public void GetInfo(string nameorid)
        {
            using (var client = new CustomWebClient())
            {
                ...
                json = client.DownloadString(GlobalVars.UserBestAPI + User_id + GlobalVars.Mode + 2);
        ...
        {
            return client.DownloadString(GlobalVars.UserAPI + username + GlobalVars.Mode + 2);
        }
    }
}
